...
class FirstFFNetwork:
    ...
    def grad(self, x, y):
        ...
        # print('\nh1, h2, h3')
        # print(self.h1, self.h2, self.h3)
        #
        # print('\ndw1, dw2, dw3, dw4, dw5, dw6, b1, b2, b3')
        # print(self.dw1, self.dw2, self.dw3, self.dw4, self.dw5, self.dw6, self.db1, self.db2, self.db3)
    ...
    def fit(self, X, Y, epochs=1, learning_rate=1, initialise=True, display_loss=False):
        ...
        for i in range(epochs):
            ...
            for x, y in zip(X, Y):
                ...
                #     exit(0)
                j += 1
            print(f'\ni = {i} dw1, dw2, dw3, dw4, dw5, dw6, db1, db2, db3')
